        ...
        package.preload[name] = function(modulename)
            ...
            if file then
                ...
                elseif string.match( name, "rules") then
                    ...
                    created_file:write(")")
                    created_file:write("\n\tlog.debug('[Rule] " .. _G.ansicolors('%{underline}' .. name) .. " with priority " .. priority .. " starting to evaluate')")
                    ...
                    created_file:write("\n\tthen")
                    created_file:write("\n\t\tlog.trace(\"Rule " .. _G.ansicolors('%{underline}' .. name) .. " evaluated as TRUE \")")
                    created_file:write("\n\t\tfor k, v in pairs(events_table) do")
                    created_file:write("\n\t\t\tevents[v]:trigger(events_parameters)")
                    created_file:write("\n\t\tend")
                    created_file:write("\n\telse")
                    created_file:write("\n\t\tlog.trace(\"Rule " .. _G.ansicolors('%{underline}' .. name) .. " evaluated as FALSE \")")
                    created_file:write("\n\tend")
        
                    created_file:write("\n\tlog.debug('[Rule] " .. _G.ansicolors('%{underline}' .. name) .. " evaluated succesfully')")
